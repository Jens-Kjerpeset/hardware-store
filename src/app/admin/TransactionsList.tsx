...
import { ChevronDown, ChevronRight, X, Package, User } from "lucide-react";
    ...
    <div className="space-y-4">
      {allMonths.map((month) => {
        ...
        const monthlyExpenses = monthTx
          .filter((t: any) => t.type === "expenditure")
          ...
          >
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="bg-dark-bg border border-dark-border text-gray-400 text-xs px-2 py-0.5  font-mono">
                  {monthTx.length} transactions
                </span>
              </div>
              <div className="flex items-center gap-6 text-sm">
                <div className="flex flex-col items-end">
                  <span className="text-gray-500 text-[11px]  font-bold  mb-0.5">
                    Rev In
                  </span>
              ...
              <div className="border-t border-dark-border/50 bg-dark-bg/50">
                <div className="w-full overflow-x-auto">
                  <table className="w-full text-sm text-left">
                    <thead className="text-xs text-gray-400 bg-dark-surface/50  border-b border-dark-border">
                      <tr>
                      ...
                      {monthTx.map((t: any) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="px-4 py-3">
                              {isOrder ? (
                                <span className="text-gray-200">
                                  Customer Checkout ({t.items?.length || 0}{" "}
                                  items)
                                </span>
                              ) : (
                                <span className="text-rose-300">
                                  Expenditure: {t.description} ({t.category})
                                </span>
                              )}
                            </td>
                            <td className="px-4 py-3">
                              <span
                                className={`px-2 py-0.5  text-[11px] font-bold capitalize   ${
                                  isOrder
                            ...
                            <td
                              className={`px-6 py-3 text-right font-mono font-bold ${isOrder ? "text-emerald-400" : "text-rose-400"}`}
                            >
                              {isOrder ? "+" : "-"}
                              {formatCurrency(
                                isOrder ? t.totalAmount : t.amount,
                              )}
                            </td>
                          </tr>
                        );
      ...
      {selectedTransaction && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 animate-in fade-in duration-200">
          ...
          <div className="relative w-full max-w-2xl bg-dark-bg border border-dark-border  shadow-2xl flex flex-col max-h-[90vh] overflow-hidden animate-in zoom-in-95 duration-200">
            {/* Modal Header */}
            <div
            ...
            <div className="p-6 overflow-y-auto custom-scrollbar">
              <div className="grid grid-cols-2 gap-6 mb-8">
                <div>
                  <div className="text-[11px] font-bold capitalize   text-gray-500 mb-1">
                    Date
                  </div>
                ...
                <div>
                  ...
                  <span
                    className={`px-2 py-0.5  text-[11px] font-bold capitalize   inline-block ${
                      selectedTransaction.type === "order"
                ...
                {selectedTransaction.type === "expenditure" && (
                  <>
                    ...
                    <div className="col-span-2">
                      ...
                      <div className="text-sm text-gray-200 bg-dark-surface/50 p-3  border border-dark-border">
              ...
              {selectedTransaction.type === "order" &&
                selectedTransaction.customer && (
                  <div className="space-y-4 mb-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-dark-surface/30 p-4 border border-dark-border ">
                      <div>
                        <div className="text-[11px] font-bold capitalize text-gray-500 mb-1 tracking-wider ">
                          Name
                        </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      {selectedTransaction.items.map((item: any) => (
                        <div
                          key={item.id}
                          className="flex items-center justify-between p-3 bg-dark-surface/30 border border-dark-border/50 "
                        >
            ...
            {/* Modal Footer */}
            <div
              className={`px-6 py-4 border-t border-dark-border flex justify-between items-center ${
                selectedTransaction.type === "order"
                  ? "bg-emerald-950/20"
                  : "bg-rose-950/20"
              }`}
